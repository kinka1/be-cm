...
class StockAdjustmentController extends Controller
{
    ...
    {
        $adjustment = StockAdjustment::create($request->validate(['product_id' => ['required','exists:products,id'], 'quantity' => ['required','numeric','gt:0'], 'adjustment_type' => ['required','in:increase,decrease'], 'requested_by' => ['nullable','exists:employees,id'], 'reason' => ['nullable','string']]));
